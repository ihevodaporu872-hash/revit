              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-sm rounded-lg border border-border bg-muted text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30"
                  />
                </div>
                <div>
      ...
      <Card title="Заметки встречи" subtitle="Введите сырые заметки по встрече" hover>
        <div className="space-y-4">
          <textarea
            ...
            rows={16}
            className="w-full px-3 py-2 text-sm rounded-lg border border-border bg-muted text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 resize-none font-mono"
          />
          <Button
