...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-[13px] font-semibold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/40 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "primary-glow-btn bg-primary text-primary-foreground hover:brightness-110",
        destructive:
        ...
        outline:
          "border border-border/90 bg-card/70 text-foreground shadow-xs hover:border-primary/35 hover:bg-accent/70 dark:bg-input/30 dark:border-input dark:hover:bg-input/50",
        secondary:
